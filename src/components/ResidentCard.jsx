        ...
        <article className="resident">
            <header className="resident__header">
                ...
                <div className="resident__status" >
                    ...
                    <span className="resident__value">{character?.status}</span>
                </div>
            </header>
            <section className="resident__body">
                ...
                <ul className="resident__list">
                    ...
                    <li className="resident__item"><span className="resident__label">Episodes where appears</span><span className="resident__item--value">{character?.episode.length}</span></li>
                </ul>
            </section>
        </article>
    )
